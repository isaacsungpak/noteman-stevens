...
function RenameModal({ notebook, setActionsMenuInUse }) {
    ...
    <>
      ...
      {showRenameModal && (
        <Modal onClose={renameBtnOnClose}>
          <RenameForm notebook={notebook} setShowRenameModal={setShowRenameModal} setActionsMenuInUse={setActionsMenuInUse}/>
        </Modal>
      )}
    </>
  );
